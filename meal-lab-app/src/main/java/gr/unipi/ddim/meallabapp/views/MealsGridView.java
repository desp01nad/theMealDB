...
public final class MealsGridView extends BorderPane {
    ...
    // in this case the returned Node will be a card (MealCardView or FavoriteMealCardView).
    private final Function<Meal, Node> cardCreator;

    // This constructor is used when you want the grid to behave like Search results.
     ...
     *   prefixing the title with "Results for:".
     * - setResultsWithTitle(...) allows other views (e.g. Favorites, Cooked)
